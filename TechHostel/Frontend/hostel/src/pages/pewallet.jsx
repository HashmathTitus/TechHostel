...
const Paymentmanagement=()=> {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const data = await axios.post("/api/personalExpenses/create", formData);
    console.log(data);
  ...
  const getFetchData = async () => {
    const data = await axios.get("/api/personalExpenses");
    console.log(data);
    if (data.data.success) {
  ...
  const handleDelete = async (id) => {
    const data = await axios.delete("/api/personalExpenses/delete/" + id);
    if (data.data.success) {
      getFetchData();
      alert(data.data.message);
    }
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    const data = await axios.put("/api/personalExpenses/update", formData);
    if (data.data.success) {
      getFetchData();
      alert(data.data.message);
